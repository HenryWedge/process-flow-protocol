...
class SepsisTest(unittest.TestCase):
    ...
    def assign(self, event):
        if event.activity in ["CRP", "Release B", "Release A", "Release D", "Release C", "Release E"]:
            node1.receive_event_2(event)
        elif event.activity in ["Admission IC", "Return ER", "ER Triage", "IV Antibiotics", "Leucocytes", "ER Registration"]:
            node2.receive_event_2(event)
        elif event.activity in ["IV Liquid", "Admission NC", "LacticAcid", "ER Sepsis Triage"]:
            node3.receive_event_2(event)
    ...
    def test_first_events_of_sepsis(self):
        ...
        self.assign(self.build_event("case3", activity="ER Registration", timestamp="2014-02-09T19:29:29.000+01:00"))
        self.assign(self.build_event("case3", activity="ER Triage", timestamp="2014-02-09T20:05:23.000+01:00"))
